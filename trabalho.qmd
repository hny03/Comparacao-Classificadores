...
# Avaliar | k = 3
conf_k_3_knn_glass <- table(Predito = pred_k_3_knn_glass, Real = y_test_knn_glass)
...
# Avaliar | todas as classes
conf_rl_glass <- table(Predito = prediction_rl_glass, Real = idx_teste_rl_glass$Class)
acc_rl_glass  <- mean(prediction_rl_glass == idx_teste_rl_glass$Class)

conf_rl_glass
acc_rl_glass

# Avaliar | apenas classes mais importantes (baseado no modelo que usa todas as classes)
conf_rl_glass <- table(Predito = prediction_rl_glass_less_att, Real = idx_teste_rl_glass$Class)
acc_rl_glass  <- mean(prediction_rl_glass_less_att == idx_teste_rl_glass$Class)
